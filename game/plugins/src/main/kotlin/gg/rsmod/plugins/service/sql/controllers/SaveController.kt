...
import gg.rsmod.plugins.service.sql.SQLService
    ...
    fun savePlayer(client: Client): Boolean {
        ...
        transaction {
            ...
            PlayerModel.update ({
                ...
                it[appearanceLooks0] = client.appearance.looks[0]
                it[appearanceLooks1] = client.appearance.looks[1]
                it[appearanceLooks2] = client.appearance.looks[2]
                it[appearanceLooks3] = client.appearance.looks[3]
                it[appearanceLooks4] = client.appearance.looks[4]
                it[appearanceLooks5] = client.appearance.looks[5]
                it[appearanceLooks6] = client.appearance.looks[6]
                it[appearanceColors0] = client.appearance.colors[0]
                it[appearanceColors1] = client.appearance.colors[1]
                it[appearanceColors2] = client.appearance.colors[2]
                it[appearanceColors3] = client.appearance.colors[3]
                it[appearanceColors4] = client.appearance.colors[4]
                if (client.appearance.gender == Gender.MALE) {
                    it[appearanceGender] = 0
                } else {
                    it[appearanceGender] = 1
                }
            }
